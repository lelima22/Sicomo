...
?>
 ...
 <?php
	...
	$query1 = "SELECT sum(total) as tot,sum(totalinc) as totinc from formulario where fecha between '$fe1' and '$fe2' and EXISTS(select nro_credito from deudor where id_e=1)";
	$resultado1 = $mysqli->query($query1);


	$query2 = "SELECT sum(total)as tot ,sum(totalinc) as totinc  from formulario where fecha between '$fe1'and '$fe2' and EXISTS(select nro_credito from deudor where id_e=2)";
	$resultado2 = $mysqli->query($query2);
	
	$query3 = "SELECT sum(total)as tot,sum(totalinc) as totinc   from formulario where fecha between '$fe1'and '$fe2' and EXISTS(select nro_credito from deudor where id_e=3)";
	$resultado3 = $mysqli->query($query3);

	$query4 = "SELECT sum(total)as tot,sum(totalinc) as totinc   from formulario where fecha between '$fe1'and '$fe2' and EXISTS(select nro_credito from deudor where id_e=4)";
	$resultado4 = $mysqli->query($query4);
	
	$query5 = "SELECT sum(total)as tot,sum(totalinc) as totinc   from formulario where fecha between '$fe1'and '$fe2' and EXISTS(select nro_credito from deudor where id_e=5)";
	$resultado5 = $mysqli->query($query5);
	
	$query6 = "SELECT sum(total)as tot,sum(totalinc) as totinc   from formulario where fecha between '$fe1'and '$fe2' and EXISTS(select nro_credito from deudor where id_e=6)";
	$resultado6 = $mysqli->query($query6);
	
	$query7 = "SELECT sum(total) as tot,sum(totalinc) as totinc   from formulario where fecha between '$fe1'and '$fe2' and EXISTS(select nro_credito from deudor where id_e=7)";
	$resultado7 = $mysqli->query($query7);
	
	$query8 = "SELECT sum(total)as tot,sum(totalinc)as totinc   from formulario where fecha between '$fe1'and '$fe2' and EXISTS(select nro_credito from deudor where id_e=8)";
	$resultado8 = $mysqli->query($query8);
	
	$query9 = "SELECT sum(total)as tot,sum(totalinc)as totinc   from formulario where fecha between '$fe1'and '$fe2' and EXISTS(select nro_credito from deudor where id_e=9)";
	$resultado9 = $mysqli->query($query9);
	
	$query10 = "SELECT sum(total)as tot,sum(totalinc)as totinc   from formulario where fecha between '$fe1'and '$fe2' and EXISTS(select nro_credito from deudor where id_e=10)";
	$resultado10 = $mysqli->query($query10);
	
	$query11 = "SELECT sum(total)as tot,sum(totalinc)as totinc   from formulario where fecha between '$fe1'and '$fe2' and EXISTS(select nro_credito from deudor where id_e=11)";
