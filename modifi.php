...
include 'conexion.php';
	...
	$cise=$_SESSION["ci"];
		...
		$eliminar= "DELETE FROM detalle where id_form='$idform'";
	...
	$insertar= "UPDATE formulario SET actividad='$actividad',nro_credito='$nrocredito',total='$suma', totalinc='$sumainc', modificado='$cise' where id_form='$idform'";
	//ejecutar consulta*/
